...
import settingsModalTemplate from './fieldEntity.settings.jade';

const FieldEntitySettingsFactory = function FieldEntitySettingsFactory($mdDialog, ConfigFactory, SchemaFactory) {
  'ngInject';
...
export default FieldEntitySettingsFactory;
